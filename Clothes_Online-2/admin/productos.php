...
if (isset($_POST)) {
    if (!empty($_POST)) {
        ...
        $query = mysqli_query($conexion, "INSERT INTO productos(nombre, descripcion, precio_normal, precio_rebajado, cantidad, huella, imagen, id_categoria) VALUES ('$nombre', '$descripcion', '$p_normal', '$p_rebajado', $cantidad, '$huella', '$foto', $categoria)");
        if ($query) {
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="huella">Huella ecologica producida (1-100)</label>
                                <input id="huella" class="form-control" type="number" name="huella" placeholder="Huella ecologica" min="1" max="100" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
